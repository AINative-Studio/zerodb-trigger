/**
 * zerodb-trigger — CommonJS entry point.
 *
 * Drop-in Trigger.dev replacement with ZeroDB event hooks.
...
module.exports = { ZeroDBTrigger, SUPPORTED_TRIGGERS, createTrigger: (opts) => new ZeroDBTrigger(opts) };
